...
export function Home() {
  ...
  useEffect(() => {
    async function fetchAnimals() {
      ...
      try {
        console.log('[Home] Buscando animais disponíveis...');
        const available = await getAnimalsByStatus('available_for_adoption');
        console.log('[Home] Animais disponíveis:', available);
      ...
      try {
        console.log('[Home] Buscando animais desaparecidos...');
        const missing = await getAnimalsByStatus('missing');
        console.log('[Home] Animais desaparecidos:', missing);
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section - Design moderno com gradiente laranja */}
      ...
      {/* Seção de Adoção - Cards em destaque */}
      ...
      {/* Seção de Desaparecidos - Destaque vermelho */}
                ...
                <div className="flex items-start md:items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-bold mb-1">
                      Nos ajude a encontrá-los
                    </h2>
                    <p className="text-red-100">
                      Esses animais estão desaparecidos e precisam voltar para casa
                    </p>
                  </div>
                </div>
      ...
      {/* Seção Como Ajudar - Cards de ação */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 text-lg max-w-2xl mx-auto">
              Existem várias formas de contribuir com nosso trabalho
            </p>
          </div>
            ...
            {[
              {
                ...
                title: 'Adote',
                description:
                  'Dê um lar amoroso para um animal que precisa de carinho e cuidado.',
                link: '/adocao',
                linkText: 'Ver animais',
                color: 'orange',
              },
              {
                icon: '🚨',
              ...
              <div
                key={item.title}
                className="group bg-slate-50 rounded-2xl p-8 text-center hover:bg-white hover:shadow-xl transition-all duration-300 border border-transparent hover:border-slate-100"
              >
                <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mx-auto mb-6 text-3xl shadow-sm group-hover:scale-110 transition-transform">
                  {item.icon}
                </div>
