        ...
        child: Column(
          ...
          children: [
            const Padding(
              ...
              child: Text("Foto do Animal", style: TextStyle(fontWeight: FontWeight.bold)),
            ),
            ListTile(
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(widget.animal == null ? 'Cadastrado com sucesso!' : 'Atualizado com sucesso!'), 
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<int?>(
                decoration: const InputDecoration(labelText: 'Idade aproximada', prefixIcon: Icon(Icons.cake), border: OutlineInputBorder()),
                value: _age,
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Descrição/História', prefixIcon: Icon(Icons.description), border: OutlineInputBorder()),
                maxLines: 3,
              ),
              ...
              if (_status == AnimalStatus.adopted || _status == AnimalStatus.missing) ...[
                ...
                TextFormField(controller: _adopterNameController, decoration: const InputDecoration(labelText: 'Nome Completo', prefixIcon: Icon(Icons.person), border: OutlineInputBorder())),
                const SizedBox(height: 16),
                ...
                const SizedBox(height: 16),
                TextFormField(controller: _adopterPhoneController, decoration: const InputDecoration(labelText: 'Telefone de Contato', prefixIcon: Icon(Icons.phone), border: OutlineInputBorder()), keyboardType: TextInputType.phone),
              ],
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _submitSuccess ? Colors.green : Colors.orange, 
                    foregroundColor: Colors.white,
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))
                  ),
                  child: _isLoading 
                    ? const CircularProgressIndicator(color: Colors.white) 
                    : Text(isEditing ? "SALVAR ALTERAÇÕES" : "CADASTRAR ANIMAL", style: const TextStyle(fontWeight: FontWeight.bold)),
                ),
              ),
            ],
          ),
    ...
    return Center(
      child: Stack(
        children: [
          ...
          if (_selectedImagePath != null || (_remoteImageUrl != null && _remoteImageUrl!.isNotEmpty))
            Positioned(
              bottom: 12,
              right: 12,
